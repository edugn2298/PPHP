  ...
  <div class="bg-cover bg-no-repeat bg-center py-36" style="background-image: url('../img/banner_pc.webp');">
    <div class="container">
      <h1 class="text-6xl text-gray-800 font-medium mb-4 capitalize">
        Fast & Fun Accessories for your phone
      </h1>
  ...
  <div class="container py-16">
    ...
    <div class="grid grid-cols-3 gap-3">
      <div class="relative rounded-sm overflow-hidden group">
        ...
        <a href="#" class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-xl text-white font-roboto font-medium group-hover:bg-opacity-60 transition">Chargers</a>
      </div>
      <div class="relative rounded-sm overflow-hidden group">
        ...
        <a href="#" class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-xl text-white font-roboto font-medium group-hover:bg-opacity-60 transition">Wires</a>
      </div>
      <div class="relative rounded-sm overflow-hidden group">
        ...
        <a href="#" class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-xl text-white font-roboto font-medium group-hover:bg-opacity-60 transition">PowerBanks</a>
      </div>
  </div>
  </div>
  <!-- ./categories -->
